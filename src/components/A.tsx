  ...
  return (
    <section id="Plan" className="py-24 px-6 bg-[#F3ECE6] text-[#444444]">
      <div className="max-w-5xl mx-auto text-center mb-20">
        <h3 className="font-serif text-xl sm:text-2xl   !tracking-widest">
          PLANS
        </h3>
      </div>
            ...
            >
              ...
              <ul className="text-sm  text-[#716D64] space-y-1">
                {plan.details.map((line, i) => (
                  <li
                    className={line.includes("30%") ? "font-semibold" : ""}
                    key={i}
                  >
                    • {line}
                  </li>
      ...
      <div className="text-3xl mb-12 mt-24 text-center  flex-col justify-center items-center gap-4 mx-auto  flex sm:text-4xl font-bold">
        ...
        <p className="text-[#716D64] text-sm font-normal">
          A fully customized session using the Pilates Reformer machine. <br />{" "}
          Ideal for building strength, improving mobility, or working through
          injuries—at your pace.
        </p>
      </div>
      ...
      <div className="text-3xl mb-12 mt-24 text-center flex-col justify-center items-center gap-4 mx-auto flex sm:text-4xl font-bold">
        ...
        <p className="text-[#716D64] text-sm font-normal">
          Train with a partner and get more personalized coaching - perfect for
          couples or friends.
        </p>
      </div>
      ...
      <div className="text-3xl mb-12 mt-24 text-center flex-col justify-center items-center gap-4 mx-auto flex sm:text-4xl font-bold">
        ...
        <p className="text-[#716D64] text-sm font-normal">
          Small group energy with the Reformer - stronger support, smoother
          progression, faster results.
        </p>
      </div>
